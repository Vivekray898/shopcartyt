...
const FooterTop = ({ contactItems, isLoading }: FooterTopProps) => {
  ...
  const mapLocations = [
    ...
    },
    {
      ...
      fullAddress: "Blieskastel, Germany",
      ...
      <div className="mt-8 border-b pb-8">
            ...
            <div className="rounded-xl overflow-hidden shadow-lg border border-slate-200">
              <div className="bg-gradient-to-r from-slate-50 to-white px-4 py-3 border-b flex justify-between items-center">
                <div className="flex-1 min-w-0">
                  <h4 className="text-sm font-bold text-slate-800 truncate">
                    {mapLocations[currentMapIndex].name}
                  </h4>
              ...
              <div className="relative">
                <iframe
                  ...
                  title={mapLocations[currentMapIndex].name}
                  className="w-full"
                />
            ...
            >
              ...
              <div className="relative">
                <iframe
                  ...
                  className="w-full"
                />
                {/* Directions Button Overlay on Desktop */}
                <a
                  href={location.mapsUrl}
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-4 md:hidden">
          {mapLocations.map((location, index) => (
            ...
            >
              {location.name.replace(/^[^ ]+ /, '')} {/* Shows short name */}
            </button>
          ))}
        </div>
      </div>
